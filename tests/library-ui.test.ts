...
function mockReader(): void {
  ;(window as unknown as { reader: ReaderApi }).reader = {
    ...
    settings: { get: async () => ({ theme: 'sepia', fontSize: 18, lineHeight: 1.9, fontFamily: 'system', mode: 'paged', uploadPortMode: 'random', maxUploadMb: 100, sourceCacheLimit: 50 }), set: async (s) => ({ ...s, theme: 'sepia', fontSize: 18, lineHeight: 1.9, fontFamily: 'system', mode: 'paged', uploadPortMode: 'random', maxUploadMb: 100, sourceCacheLimit: 50 } as never) },
    upload: {
