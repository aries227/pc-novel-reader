...
- 阅读器：左右翻页 / 上下翻页 / 滚动三种模式，字号 / 行距 / 主题调节、章节目录、进度条、快捷键翻页（`Esc` 返回书架）。
...
2. 查词：内置 ECDICT 英汉词典（约 7.8 万词条 + 词形变化 + 中考/高考/四六级/考研/托福/雅思/GRE 等考试标签），显示音标、中文释义、考试标签与 Tatoeba 中英例句，也可一键加入生词本。
